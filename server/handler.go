...
import (
	...
	sqle "github.com/eturella/go-mysql-test/engine"

	"github.com/eturella/go-mysql-test/auth"
	"github.com/eturella/go-mysql-test/internal/sockstate"
...
func (h *Handler) ComPrepare(c *mysql.Conn, query string) ([]*querypb.Field, error) {
	return nil, nil
}
